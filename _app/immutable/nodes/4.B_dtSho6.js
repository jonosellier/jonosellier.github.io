import{s as H,n as _}from"../chunks/scheduler.DIcuhWVn.js";import{S as M,i as j,k as J,s as p,e as h,l as A,f as c,c as u,m,n as g,o as q,g as a,p as N,q as D,d as o,r as L}from"../chunks/index.Dg8JnZfo.js";import{T as F}from"../chunks/title.Da9YHuet.js";function $(C){let s,b,i,T=`<h1>Playnite</h1> <h2>Extensions, Themes, and Direct Contributions</h2> <p>Built using WPF, and C#</p> <p>Playnite is a game library aggregator that combines PC games from multiple sources into a single
		...
		PC form-factors.</p> <p>I&#39;ve also contributed to other community themes and extensions through both advisory support and
		...
		have come to appreciate the differing development processes.</p> <h3>Toggle</h3> <p>A Playnite Theme designed to work well on handheld devices with a number of tricks to make it
		behave better with touchscreens, an input that the project never intended to target. It has
		amassed thousands of downloads and has an active user base.</p> <h3>Now Playing</h3> <p>Using heuristic-based process tracking, this extension finds the currently running game&#39;s
		...
		would be used to.</p> <h3>Mo&#39; Data</h3> <p>Playnite doesn&#39;t provide out of the box support for certain system information like storage
		usage and network info for permissions reasons. Mo&#39; Data acts as an opt-in way of gathering
		forwarding this information for other themes (including my own) to utilize in their UIs.</p> <h3 class="mt-8">Addon Links</h3> <div class="mt-4 mb-4"><a class="btn" href="https://playnite.link/addons.html#Toggle_28b7d2c0-105b-4632-8dca-d11348bd61d2">Toggle</a> <a class="btn" href="https://playnite.link/addons.html#NowPlaying_db4e7ade-57fb-426c-8392-60e2347a0209">Now Playing</a> <a class="btn" href="https://playnite.link/addons.html#MoData_5a0a672a-998a-4cf3-94ea-44543de5afcb">Mo Data</a></div>`,f,n,I=`<h1>Better Start</h1> <h2>Custom New-Tab Page</h2> <p>Built using SvelteKit and Tailwind CSS.</p> <p>I have always found that new tab pages are great for personal use but lack in a more constrained
		...
		cross-platform under one codebase was quite pleasing too.</p> <div class="mt-8 mb-4"><a href="https://github.com/jonosellier/nav-a-bull" class="btn me-4">Source <i class="bi bi-github"></i></a></div>`,k;return s=new F({props:{text:"Projects"}}),{c(){J(s.$$.fragment),b=p(),i=h("div"),i.innerHTML=T,f=p(),n=h("div"),n.innerHTML=I,y=p(),r=h("div"),r.innerHTML=x,w=p(),l=h("div"),l.innerHTML=S,v=p(),d=h("div"),d.innerHTML=P,this.h()},l(e){A(s.$$.fragment,e),b=c(e),i=u(e,"DIV",{class:!0,"data-svelte-h":!0}),m(i)!=="svelte-1xnqn49"&&(i.innerHTML=T),f=c(e),n=u(e,"DIV",{class:!0,"data-svelte-h":!0}),m(n)!=="svelte-134thzx"&&(n.innerHTML=I),y=c(e),r=u(e,"DIV",{class:!0,"data-svelte-h":!0}),m(r)!=="svelte-1tzoy0r"&&(r.innerHTML=x),w=c(e),l=u(e,"DIV",{class:!0,"data-svelte-h":!0}),m(l)!=="svelte-134ggxd"&&(l.innerHTML=S),v=c(e),d=u(e,"DIV",{class:!0,"data-svelte-h":!0}),m(d)!=="svelte-1tg40rp"&&(d.innerHTML=P),this.h()},h(){g(i,"class","project"),g(n,"class","project"),g(r,"class","project"),g(l,"class","project"),g(d,"class","project")},m(e,t){q(s,e,t),a(e,b,t),a(e,i,t),a(e,f,t),a(e,n,t),a(e,y,t),a(e,r,t),a(e,w,t),a(e,l,t),a(e,v,t),a(e,d,t),k=!0},p:_,i(e){k||(N(s.$$.fragment,e),k=!0)},o(e){D(s.$$.fragment,e),k=!1},d(e){e&&(o(b),o(i),o(f),o(n),o(y),o(r),o(w),o(l),o(v),o(d)),L(s,e)}}}class W extends M{constructor(s){super(),j(this,s,null,$,H,{})}}export{W as component};
