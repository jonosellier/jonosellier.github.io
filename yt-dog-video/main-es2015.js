...
const routes = [
    ...
    { path: 'v/:vid', component: _video_video_component__WEBPACK_IMPORTED_MODULE_3__["VideoComponent"] },
    { path: 's/:term', component: _main_main_component__WEBPACK_IMPORTED_MODULE_2__["MainComponent"] },
    { path: '**', redirectTo: '' }
];
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _search_handler_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./search-handler.service */ "./src/app/search-handler.service.ts");
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, { declarations: [_app_component__WEBPACK_IMPORTED_MODULE_3__["AppComponent"],
        ...
        _video_video_component__WEBPACK_IMPORTED_MODULE_7__["VideoComponent"]], imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"],
        _app_routing_module__WEBPACK_IMPORTED_MODULE_2__["AppRoutingModule"],
        _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_4__["BrowserAnimationsModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormsModule"]] }); })();
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _search_handler_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../search-handler.service */ "./src/app/search-handler.service.ts");
...
function MainComponent_section_5_div_2_Template(rf, ctx) { if (rf & 1) {
...
function MainComponent_section_5_Template(rf, ctx) { if (rf & 1) {
...
function MainComponent_section_6_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "section");
...
const _c2 = function (a0) { return { "big": a0 }; };
class MainComponent {
    //for                       Searching                             Getting path
    constructor(search, router, route) {
        this.search = search;
        this.router = router;
        this.route = route;
    ...
    doSearch() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            if (!this.term)
                return; //empty search
            const res = yield this.search.search(this.term, "firstPage");
    ...
    continueSearch() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            const res = yield this.search.search(this.term, this.nextPage);
            console.log(res);
    ...
    getSuggestions() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            const res = yield this.search.search("", "firstPage");
            this.suggestedVideos = res.items;
            this.showSuggestions = true;
            this.suggestionLooper = setInterval(() => {
                this.suggestionIdx = ++this.suggestionIdx % this.suggestedVideos.length;
            }, 5000);
        });
    }
    onWindowScroll() {
        ...
        let max = document.documentElement.scrollHeight - 20; //start a bit from bottom for better UX
        if (pos >= max && this.searchConducted)
            this.continueSearch();
    }
}
MainComponent.ɵfac = function MainComponent_Factory(t) { return new (t || MainComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_search_handler_service__WEBPACK_IMPORTED_MODULE_2__["SearchHandlerService"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"])); };
MainComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: MainComponent, selectors: [["app-main"]], hostBindings: function MainComponent_HostBindings(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("scroll", function MainComponent_scroll_HostBindingHandler($event) { return ctx.onWindowScroll($event); }, false, _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵresolveWindow"]);
    } }, features: [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵProvidersFeature"]([_search_handler_service__WEBPACK_IMPORTED_MODULE_2__["SearchHandlerService"]])], decls: 7, vars: 8, consts: [[1, "app-root", 3, "scroll"], [3, "routerLink"], [3, "ngClass"], ["id", "search", "matInput", "", "placeholder", "Search", "type", "text", 3, "ngModel", "ngModelChange", "keyup.enter"], [4, "ngIf"], [1, "video-holder"], ["class", "video-card", 3, "backgroundImage", "routerLink", 4, "ngFor", "ngForOf"], [1, "loading"], [1, "video-card", 3, "routerLink"], [1, "vc-content"], [1, "suggested-video-card", 3, "routerLink"], [1, "thumbnail"]], template: function MainComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("scroll", function MainComponent_Template_div_scroll_0_listener($event) { return ctx.onWindowScroll(); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("ngModelChange", function MainComponent_Template_input_ngModelChange_4_listener($event) { return ctx.term = $event; })("keyup.enter", function MainComponent_Template_input_keyup_enter_4_listener($event) { return ctx.searchRedirect(); });
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](MainComponent, [{
    ...
    }], function () { return [{ type: _search_handler_service__WEBPACK_IMPORTED_MODULE_2__["SearchHandlerService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] }]; }, { onWindowScroll: [{
...
class SearchHandlerService {
    constructor() {
        ...
        this.searchUrl = `https://www.googleapis.com/youtube/v3/search?key=${this.apiKey}&part=snippet&type=video&maxResults=50&q=dog`;
        this.detailsUrl = `https://www.googleapis.com/youtube/v3/videos?part=id%2C%20snippet&key=${this.apiKey}&id=`;
    }
    search(term, page) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            let apiCall = this.searchUrl;
            if (term)
                apiCall += "%20" + term;
            if (page != "firstPage")
                apiCall += `&pageToken=${page}`;
            const response = yield fetch(apiCall);
    ...
    getVideoDetails(id) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            const response = yield fetch(this.detailsUrl + id);
            const data = yield response.json();
            return data;
        });
    }
}
SearchHandlerService.ɵfac = function SearchHandlerService_Factory(t) { return new (t || SearchHandlerService)(); };
SearchHandlerService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjectable"]({ token: SearchHandlerService, factory: SearchHandlerService.ɵfac, providedIn: 'root' });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](SearchHandlerService, [{
...
class VideoComponent {
    constructor(route, router, sanitizer, search) {
        this.route = route;
        this.router = router;
    ...
    getVideoDetails() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            this.video = yield this.search.getVideoDetails(this.videoID);
        });
    }
    searchRedirect() {
        if (!this.term)
...
VideoComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: VideoComponent, selectors: [["app-video"]], features: [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵProvidersFeature"]([_search_handler_service__WEBPACK_IMPORTED_MODULE_2__["SearchHandlerService"]])], decls: 10, vars: 5, consts: [[1, "video-container"], ["id", "search", "matInput", "", "placeholder", "Search for more dog videos", "type", "text", 1, "wide", "sm", 3, "ngModel", "ngModelChange", "keyup.enter"], ["frameborder", "0", "allow", "accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture", "allowfullscreen", "", 1, "video-frame", 3, "src"]], template: function VideoComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](1, "input", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("ngModelChange", function VideoComponent_Template_input_ngModelChange_1_listener($event) { return ctx.term = $event; })("keyup.enter", function VideoComponent_Template_input_keyup_enter_1_listener($event) { return ctx.searchRedirect(); });
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](VideoComponent, [{
    ...
    }], function () { return [{ type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] }, { type: _angular_platform_browser__WEBPACK_IMPORTED_MODULE_4__["DomSanitizer"] }, { type: _search_handler_service__WEBPACK_IMPORTED_MODULE_2__["SearchHandlerService"] }]; }, null); })();
...
module.exports = __webpack_require__(/*! C:\Users\JonSe\Documents\USF\Personal\yt-dog-video\src\main.ts */"./src/main.ts");
